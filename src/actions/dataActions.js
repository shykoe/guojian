...
export const crudGetList = (resource, pagination, sort, filter, username, role, cancelPrevious = true) => ({
    type: CRUD_GET_LIST,
    payload: { pagination, sort, filter, username, role },
...
export const crudUpdate = (resource, id, data, previousData, basePath, username, redirect = true) => ({
    type: CRUD_UPDATE,
    payload: { id, data, previousData, basePath, redirect, username },
